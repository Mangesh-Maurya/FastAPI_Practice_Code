...
def load_data():
    with open('FastAPI_Tutorials/patients.json', 'r') as f:
        data = json.load(f)

    return data

def save_data(data):
    with open('FastAPI_Tutorials/patients.json', 'w') as f:
        json.dump(data, f)
...
@app.get('/sort')  # ... = means required in query parameter
...
def update_patient(patient_id: str, patient_update: PatientUpdate):
    ...
    patient_pydantic_obj = Patient(**exiting_patient_info)
    # -> pydantic object -> dict
    exiting_patient_info = patient_pydantic_obj.model_dump(exclude='id')
